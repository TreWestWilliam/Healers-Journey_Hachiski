...
public class Vector3RefDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        {
            Vector3 varVal = (variable.objectReferenceValue as Vector3Variable).Value;
            GUI.enabled = false;
            Vector3 newValue = EditorGUI.Vector3Field(position, "", varVal);
            GUI.enabled = true;
        }
