...
public class AilmentDataDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        {
            icon = (property.objectReferenceValue as AilmentData).icon.Value;
            Name = (property.objectReferenceValue as AilmentData).Name;
        }
